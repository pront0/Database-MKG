...
<html>
    ...
    <body>
        ...
        <form action="search_met3.php" method="post" name="postform">
            ...
            <table align="center" border="0">
                <tr>
                    ...
                    <td colspan="2" width="70"><input type="reset" value="Back" onclick="document.location='met3.php'"/></td>
                </tr>
            </table>
        </form><br />
      </div>
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='search_met3.php';
            </script>
            ...
            <?php
            $query=mysqli_query($db_link,"select * from met3 WHERE Station like '%".$station."%'");
            }
        ?>
