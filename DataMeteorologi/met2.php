...
<html lang="en" dir="ltr">
  ...
  <div id="main">
    ...
    <div align="center">
    <a href="export_met2.php"><button>Export to Excel</button></a>
    <a href="add_met2.php"><button>Add Data</button></a>
    <a href="search_met2.php"><button>Cari Data</button></a><br/>
  </div>
    <hr/>
  </div>

  <?php
    include 'data_met2.php';
  ?>
