...
<table border="1">
 ...
 <tr>
  ...
  $data = mysqli_query($db_link, "select * from met2");
  ...
  <tr>
    ...
    <td p align="center">
	<a href="edit_met2.php?ni=<?php echo $d['Station'];?>" title="Edit data ini"> EDIT ||</a>
	<a href="delete_met2.php?ni=<?php echo $d['Station'];?>" onclick="return confirm ('Apakah anda yakin ingin menghapus data ini ?');"> HAPUS </a>
    </td>
  </tr>
